...
def generate_quiz(content):
    system_prompt = """You are given a Python programming topic. Your task is to generate a set of five quiz questions related to the topic. Each question should be clear, concise, and designed to test the user's understanding of the key concepts covered in the topic. For each question, provide four multiple-choice options (A, B, C, D)."""

    format_spec = json.dumps([{'question': 'Question text', 'options': ['Option A', 'Option B', 'Option C', 'Option D'], 'correct_answer': 'Option A'}])

    user_prompt = f"This is Topic: {content}. Return the response in JSON format like this: {format_spec},don't give any introduction, conclusion, no unnecessary information."
